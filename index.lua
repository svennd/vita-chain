...
dark_green   = Color.new(0, 128, 0)
silver   = Color.new(60, 60, 60) -- grey
deep   = Color.new(0, 0, 99)
nuke   = Color.new(200, 255, 0)
...
function populate_atoms(n, max_atom)   
   ...
   while atom_id < (n+1) do
      ...
      atoms[atom_id] = {
                     id = selected_atom, -- vita shell deleted these for some reason
